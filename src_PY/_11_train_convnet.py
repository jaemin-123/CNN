...
if __name__ == '__main__':
    ...
    parser.add_argument('--channel_sizes', help='channel layer dimensions', nargs='+', type=int, default=[3, 3])
    ...
    mnist_trainset = datasets.MNIST(root=args.data_dir, train=True, download=True, transform=transforms.Compose([
        transforms.ToTensor(),
